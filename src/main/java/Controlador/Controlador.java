    ...
    public static int contarAlumnos() {
        ...
        try {
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                // Incrementar el contador por cada línea de alumno
                contador++;
            }
            lector.close();
        } catch (IOException e) {
    ...
    public static int contarAlumnosMasculinos() {
        ...
        try {
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                String[] campos = linea.split(",");
                if (campos.length >= 17) { // Asegurarse de que hay al menos 17 campos (datos del alumno y género)
                    String generoAlumno = campos[16].trim();

                    // Incrementar el contador solo si el género es masculino
        ...
        try {
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                if (campos.length >= 17) { // Asegurarse de que hay al menos 17 campos (datos del alumno y género)
                    ...
                    // Incrementar el contador solo si el género es femenino
        ...
        try {
            ...
            while ((linea = lector.readLine()) != null) {
                ...
                if (campos.length >= 17) { // Asegurarse de que hay al menos 17 campos (datos del alumno y género)
                    ...
                    // Incrementar el contador solo si el género es "otro"
